	...
	<div class = "row">
		...
		<div class = "col-md-6">
			...
			<form action ="Product_Detail1.jsp" method = "post">
				...
				<textarea name = "description" class = "form_control" placeholder = "Enter Product Description"></textarea><br/>
				<input type = "text" name = "initial_price" class = "form_control" placeholder = "Enter Initial Price"/><br/>
				<input type = "date" name = "schedule_date" class = "form_control" placeholder = "Enter Auction Date"/><br/>
